import { cancellable, CancellableToken } from "../cancellable";
 ...
 */
export function filter<D extends unknown[]>(data: D, predicate: (item: D[number], token: CancellableToken) => Promise<boolean>, options?: FilterOptions) {
